...
if (Test-CommandExists Cygwin) {
	Write-Host "[Upgrade Cygwin Packages]" -ForegroundColor $color2
	Write-Host ""

	Write-Host "Upgrading all Cygwin packages..." -ForegroundColor $color3
	if ($verbose.all -or $verbose.Cygwin) {
	...
	Write-Host "Done upgrading all Cygwin packages." -ForegroundColor $color3
	Write-Host ""
}
...
if (Test-CommandExists scoop) {
	Write-Host "[Upgrade Scoop Packages]" -ForegroundColor $color2
	Write-Host ""
	Write-Host "Upgrading all Scoop packages..." -ForegroundColor $color3
	scoop update --all
	Write-Host ""

	Write-Host "Done upgrading all Scoop packages." -ForegroundColor $color3
	Write-Host ""
	Write-Host "..." -ForegroundColor $color3
	Write-Host ""
}
...
if (Test-CommandExists Get-WindowsUpdate -and Test-CommandExists Start-Process) {
  ...
  if (!Test-CommandExists PSWindowsUpdate) {
