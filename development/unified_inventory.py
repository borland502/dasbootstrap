...
if __name__ == "__main__":
  ...
  for p_host in inventory.proxmox_hosts:
    for n_host in inventory.nmap_hosts:
      ...
      if str(p_host_vars.get("ansible_default_ipv4")["address"]) == n_host.address or p_host_vars.get("inventory_hostname_short") == n_host_vars.get("inventory_hostname_short"):
